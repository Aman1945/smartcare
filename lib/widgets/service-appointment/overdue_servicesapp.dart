...
class _OverdueServicesappState extends State<OverdueServicesapp> {
  ...
  List<Map<String, dynamic>> get _filteredFollowups {
    if (_showOnlyFavorites) {
      return favController.favoriteOverdueServiceAppointments;
    }
    return favController.overdueServiceAppointments;
  }
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return DummyFollowupItem(
                      ...
                      enquiryData: item,
                      onUpdate: (updatedData) {
                        favController.updateOverdueServiceAppointment(item['task_id'], updatedData);
                      },
                    onFavoriteToggle: () {
  favController.toggleOverdueServiceAppointmentFavorite(item['task_id']);
},

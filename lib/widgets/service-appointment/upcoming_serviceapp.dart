...
//         name: widget.name,
//         mobile: widget.mobile,
//         status: "Ringing...", // or "Upcoming Call"
//       ),
//     ),
//   );
// }
...
import 'package:smartcare/widgets/followups/edit_followup_popup.dart';
import 'package:smartcare/widgets/service-appointment/edit_service_appoinment_popup.dart'; 

class UpcomingServiceapp extends StatefulWidget {
  final bool showOnlyFavorites;
  final bool showEmptyState;
  final bool showHeader; // New parameter to control header visibility

  
  const UpcomingServiceapp({
    super.key,
  ...
  @override
  State<UpcomingServiceapp> createState() => _UpcomingServiceappState();
}

class _UpcomingServiceappState extends State<UpcomingServiceapp> {
  ...
  List<Map<String, dynamic>> get _filteredFollowups {
    if (_showOnlyFavorites) {
      return favController.favoriteServiceAppointments;
    }
    return favController.serviceAppointments;
  }
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return DummyFollowupItem(
                      ...
                      // },
                               onFavoriteToggle: () {   favController.toggleServiceAppointmentFavorite(item['task_id']);
},
                    );
                  },
                ),

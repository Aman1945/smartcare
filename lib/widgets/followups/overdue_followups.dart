...
class OverdueFollowups extends StatefulWidget {
  ...
  @override
  State<OverdueFollowups> createState() => _OverdueFollowupsState();
}

class _OverdueFollowupsState extends State<OverdueFollowups> {
  ...
  List<Map<String, dynamic>> get _filteredFollowups {
    if (_showOnlyFavorites) {
      return favController.favoriteOverdueFollowups;
    }
    return favController.overdueFollowups;
  }
...
return DummyFollowupItem(
  ...
  enquiryData: item,
  onUpdate: (updatedData) {
    favController.updateOverdueFollowup(item['task_id'], updatedData);
  },
  onFavoriteToggle: () {
    favController.toggleOverdueFavorite(item['task_id']);
  },
);
